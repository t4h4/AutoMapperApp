...
namespace FluentValidationApp.Controllers
{
    ...
    public class CustomersApiController : ControllerBase
    {
        ...
        private readonly IValidator<Customer> _customerValidator; //nesne oluşturuldu //private oldugu için bestpractice açısından alt tire uygun.
        ...
        {
            Customer customer = new Customer { Id = 1, Name = "Veli", Email = "veli@veli.com", Age = 40 };
